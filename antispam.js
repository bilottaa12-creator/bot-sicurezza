    ...
    async onMessage(message, ctx) {
        ...
        if (troppiMessaggi || troppeRipetizioni) {
            ...
            try {
                ...
                console.error("[ANTISPAM] Errore nel cancellare il messaggio:", err.message);
            }
            ...
            try {
                ...
                await message.channel.send(
                    `🤖 **Anti-spam:** ${message.author} è stato messo in timeout per ${DURATA_TIMEOUT_MIN} minuti (spam rilevato automaticamente).`
                );
            } catch (err) {
